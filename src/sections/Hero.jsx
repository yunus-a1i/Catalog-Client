          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            >
              <motion.h1
                ...
                className="font-GtSuper text-5xl lg:text-7xl font-light text-mainHeading dark:text-darkMainHeading text-mainHeading dark:text-darkMainHeading leading-tight tracking-tighter"
              >
                The Ultimate{" "}
              ...
              <motion.p
                ...
                className="font-Manrope text-xl lg:text-2xl text-textContent dark:text-darkTextContent text-textContent dark:text-darkTextContent leading-relaxed max-w-3xl mx-auto"
              >
            ...
            >
              <div className="relative">
                ...
                />
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-textContent dark:text-darkTextContent text-textContent dark:text-darkTextContent" />
              ...
              {[
                ...
                <div key={index} className="text-center">
                  <motion.p
                    ...
                    className="font-GtSuper text-3xl text-mainHeading dark:text-darkMainHeading text-mainHeading dark:text-darkMainHeading mb-2"
                  >
                    {stat.number}
                  </motion.p>
